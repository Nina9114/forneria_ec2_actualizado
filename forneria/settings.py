...
ALLOWED_HOSTS = [host.strip() for host in config('ALLOWED_HOSTS', default='127.0.0.1,localhost,54.209.10.202,ec2-54-209-10-202.compute-1.amazonaws.com').split(',') if host.strip()]
